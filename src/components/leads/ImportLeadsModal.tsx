...
export const ImportLeadsModal: React.FC<ImportLeadsModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Handle success - new format only
      if (result.success) {
        ...
        if (stats) {
          showSuccess(
            `Import completed! ${stats.imported_count} leads imported, ${stats.skipped_count} duplicates skipped, ${stats.failed_count} failed.`
          );
        } else {
  ...
  // Replace the existing success dialog content with this enhanced version
  if (importSuccess) {
    return (
          ...
          <DialogHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DialogDescription>
                  Facebook leads import has been completed successfully.
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <div className="font-medium">
                          {importResult.form_info.form_name}
                        </div>
                      </div>
                      <div>
                        <span className="text-muted-foreground">Category:</span>
                        <div className="font-medium">
                          {importResult.form_info.assigned_category}
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-4 bg-blue-50 rounded-lg">
                        <div className="text-2xl font-bold text-blue-600">
                          {importResult.stats.total_facebook_leads}
                        </div>
                      ...
                      <div className="text-center p-4 bg-green-50 rounded-lg">
                        <div className="text-2xl font-bold text-green-600">
                          {importResult.stats.imported_count}
                        </div>
                        <div className="text-sm text-muted-foreground">
                      ...
                      <div className="text-center p-4 bg-yellow-50 rounded-lg">
                        <div className="text-2xl font-bold text-yellow-600">
                          {importResult.stats.skipped_count}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          Duplicates Skipped
                        </div>
                      ...
                      <div className="text-center p-4 bg-red-50 rounded-lg">
                        <div className="text-2xl font-bold text-red-600">
                          {importResult.stats.failed_count}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          Failed Imports
                        </div>
